...
def assistant(command):
    ...
    message = 'Motherfucker stop acting so innocent ! I can understand commands like send email, open gmail, open website xyz.com and tell me a joke'
    if 'hello' in command:
        talkToMe(message)
...
talkToMe('Yo motherfucker what do you need !')
